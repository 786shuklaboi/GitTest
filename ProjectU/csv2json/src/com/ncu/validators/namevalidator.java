...
public class NameValidator{
	public boolean nameValidator(String filename, String filetype){
		...
		PropertyConfigurator.configure("C:\\Users\\AKASH\\Desktop\\ProjectU\\csvtojson\\configs\\logger\\logger.properties");

		try{
			input = new FileInputStream("C:\\Users\\AKASH\\Desktop\\ProjctU\\csvtojson\\configs\\constants\\exceptions.properties");	
			prop.load(input);
